...
function UserProfile() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-blue-900 relative px-5 py-16 mx-auto sm:max-w-md my-10 shadow-[inset0-2px_4px_rgba(0,0,0,0.6)] rounded-[31px]">
          ...
          <div className="flex  grid-cols-2 gap-8">
            <div className="flex justify-start md:space-y-16 mx-5">
              <ul className=" space-y-10">
                <li>
                  <h3 className="  text-xl md:text-xl font-bold text-gray-500">
                    Vous êtes :
                  </h3>
                ...
                <li>
                  <h3 className=" text-xl md:text-xl font-bold text-gray-500 tracking-wide">
                    Supprimer le compte :
                  </h3>
                </li>
              </ul>
